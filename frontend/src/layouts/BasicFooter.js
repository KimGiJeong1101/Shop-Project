        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-9">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="text-xl mb-4">
              ...
              <p className="text-base">AM10:00 - PM 15:00</p>
            </div>
          </div>
          <div className="col-span-1 md:col-span-1">
            <div className="text-xl mb-4">
              <h4 className="font-bold ">INFO</h4>
              <p className="text-xs">상호. (주)벨앙주</p>
              <p className="text-xs">대표자. 김현우</p>
              <p className="text-xs">
                사업자 등록번호. 3405-838-016355[사업자정보확인]
              </p>
              <p className="text-xs">통신판매업. 제 2026-서울-4359호</p>
              <p className="text-xs">
                주소. 12284 경기도 가상시 가상지금로 202 (가상동)
                현대한국타워DIMC BF05-0037호
              </p>
              <p className="text-xs">
                개인정보보호책임자. 벨앙주 (BelleAnge@gelleange.co.kr)
              </p>
              <p className="text-xs">
                고객님은 안전거래를 위해 결제 시 저희 쇼핑몰에서 가입한
