        ...
        <div>
          ...
          {signin.social ? (
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-3xl mb-2">
                소셜로그인
              </h2>
              <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-2xl mt-2">
                정보수정
              </h2>
            </div>
          ) : (
