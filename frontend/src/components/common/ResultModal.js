const ResultModal = ({ title, content, callbackFn }) => {
  return (
    ...
    >
      <div className="absolute bg-white shadow dark:bg-amber-50 opacity-100 w-1/4 rounded  mt-10 mb-10 px-6 min-w-[600px]">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="mt-8 text-[#059669] mx-auto h-11 rounded-full bg-[#D1FAE5] w-11"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
        ...
        <div className="text-4xl pt-4 pb-4 text-center">{content}</div>
