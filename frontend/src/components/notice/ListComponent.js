        ...
        <div className="px-20">
            ...
            <div className="flex flex-col mx-auto">
                {serverData.dtoList.map((notice, index) =>
                    <div
                        key={notice.nno}
                        className="w-full min-w-[400px] my-1"
                    >
                        <div className="flex flex-col h-full bg-white p-4 border-b-2 border-gray-300">
                            <div className="flex items-center justify-between">
                                <div className="w-1/4 text-base">{(serverData.totalCount - (serverData.current - 1) * size) - index}</div>
                                ...
                                <div className="w-1/4 text-center text-base">{formatDate(notice.regDate)}</div>
                            </div>
                        </div>
                    </div>
                )}
