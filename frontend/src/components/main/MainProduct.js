...
const ListComponent = () => {
  const { page, size, refresh, moveToListOne, moveToRead, moveToReadProduct } =
    useCustomMove();
            ...
            <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
              {serverData.dtoList.slice(0, 4).map((product) => (
                <div
                  ...
                  onClick={() => moveToReadProduct(product.pno)}
                ...
                >
                  ...
                  <div className="mt-4 flex flex-col">
                    {" "}
                    {/* 위아래로 배치하기 위해 flex-col 클래스 추가 */}
                    <div>
                      <h3
                        className="text-sm text-gray-700 font-extrabold overflow-hidden whitespace-nowrap truncate"
                      ...
                      {/* product.pname 요소 */}
                      <p
                        className="mt-1 text-sm font-extrabold text-gray-500 overflow-hidden whitespace-nowrap truncate"
                        style={{ maxWidth: "250px" }}
                      >
                        {product.pdesc}
                      </p>
                    ...
                    <div className="mt-auto">
                      {" "}
                      {/* 위쪽 여백을 자동으로 채우기 위해 mt-auto 클래스 추가 */}
                      {/* product.price 요소 */}
