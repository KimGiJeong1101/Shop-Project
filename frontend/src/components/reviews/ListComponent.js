...
const ListComponent = ({ pno }) => {
  ...
  return (
    <div
      className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 z-0"
      style={{ width: "1000px", zIndex: -10 }}
    >
      ...
      {serverData.map((review) => (
        <li
          key={review.rno}
          className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-8 sm:pt-8 lg:mx-0 lg:max-w-none lg:grid-cols-3"
        >
          <div className="flex max-w-xl flex-col items-start justify-between ">
            ...
            <p className="text-sm leading-6 text-gray-900">
              {review.reviewContent.length > 20
                ? review.reviewContent.substring(0, 40) + "..."
            ...
            <p
              className="mt-1 text-xs leading-5 text-gray-500 cursor-pointer"
